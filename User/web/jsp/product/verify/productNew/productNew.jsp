...
<body ng-app="m" ng-controller="c" ng-init='index = "审核管理"; subIndex = "优品审核"'>
...
<div class="container" style="width: 100%;"><%--nav特殊情况width设为100%--%>
    <div class="container-fluid" style="margin-top: 5px;">
        ...
        <div class="ng-hide" ng-show="nav == 0">
            <%@ include file="/jsp/product/verify/productNew/item.jspf" %>
        </div>
        <div class="ng-hide" ng-show="nav == 1">
            <%@ include file="/jsp/product/verify/productNew/price.jspf" %>
        </div>
